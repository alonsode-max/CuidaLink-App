...
object SupabaseConfig {
    // TODO(integración): confirmar con el compañero el proyecto Supabase fuente de verdad.
    // Este proyecto difiere del backend del compañero; ajustar URL/clave antes de probar.
